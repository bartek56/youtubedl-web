...
def create_app(config=Config):
    ...
    from .routes.youtubeDownloader_routes import youtubeDownloader_bp, register_socketio_youtubeDownloader
    ...
    app.register_blueprint(youtubeDownloader_bp)
    app.register_blueprint(alarm_bp)
    app.register_blueprint(mail_bp)

    register_socketio_youtubeDownloader(socketio)
